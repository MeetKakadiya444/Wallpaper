...
export default function SplashScreen({ navigation }) {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: "#FFFFFF", flex: 1, alignItems: "center" }}>
            <View style={{flexL:1, marginTop: 30, height: '57%', width: '100%',alignItems:'center',justifyContent:'center'}}>
            ...
            <View style={{ height: '10%', width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                <TouchableOpacity onPress={handleSkip} style={{ backgroundColor: "#4794FF", height:responsiveHeight(5), width:responsiveWidth(26), borderRadius: 20, alignItems: 'center', justifyContent: 'center' }}>
