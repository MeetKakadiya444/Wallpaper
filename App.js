...
//         options={{
//           tabBarIcon: ({ color }) => (
//             <View style={{ height: responsiveHeight(5), width: responsiveWidth(10.5), backgroundColor: "#FFFFFF", justifyContent: 'center', alignItems: 'center', borderRadius: 40, elevation: 10, shadowColor: "#000000", shadowOffset: { width: 6, height: 6 }, shadowOpacity: 1, shadowRadius: 9 }}>
//               <Image source={HomeIcon} style={{ width: 24.5, height: 22, tintColor: color }} />
//             </View>
//           ),
//         }}
//       />
...
//         options={{
//           tabBarIcon: ({ color }) => (
//             <View style={{ height: responsiveHeight(5), width: responsiveWidth(10.6), backgroundColor: "#FFFFFF", justifyContent: 'center', alignItems: 'center', borderRadius: 40, elevation: 10, shadowColor: "#000000", shadowOffset: { width: 6, height: 6 }, shadowOpacity: 1, shadowRadius: 9 }}>
//               <Image source={LikeIcon} style={{ width: 22.5, height: 20, tintColor: color }} />
//             </View>
//           ),
//         }}
//       />
...
//           tabBarIcon: ({ color }) => (
//             <View style={{ height: responsiveHeight(5), width: responsiveWidth(10.5), backgroundColor: "#FFFFFF", justifyContent: 'center', alignItems: 'center', borderRadius: 40, elevation: 10, shadowColor: "#000000", shadowOffset: { width: 6, height: 6 }, shadowOpacity: 1, shadowRadius: 9 }}>
//               <Image source={DownloadIcon} style={{ width: 18, height: 26, tintColor: color }} />
//             </View>
//           ),
//         }}
//       />
